...
public class MapGenCaves {
	...
	public MapGenCaves(Random rand) {
		this.rand = rand;
		this.range = 8;
	}
	...
	protected void generateCaveNode(long par1, int par3, int par4, byte[] par5ArrayOfByte, double par6, double par8,
		...
		for (boolean var28 = var25.nextInt(6) == 0; par15 < par16; ++par15) {
			double var29 = 1.5D + (double) (Math.sin((float) par15 * (float) Math.PI / (float) par16) * par12 * 1.0F);
			double var31 = var29 * par17;
			float var33 = (float) Math.cos(par14);
			float var34 = (float) Math.sin(par14);
			par6 += (double) (Math.cos(par13) * var33);
			par8 += (double) var34;
			par10 += (double) (Math.sin(par13) * var33);
			...
			if (!var54 && par15 == var27 && par12 > 1.0F && par16 > 0) {
				this.generateCaveNode(	var25.nextLong(),
										par3,
										par4,
										par5ArrayOfByte,
										par6,
			...
			if (var54 || var25.nextInt(4) != 0) {
				...
				if (par6 >= var19 - 16.0D - var29 * 2.0D && par10 >= var21 - 16.0D - var29 * 2.0D
					...
					int var55 = MathUtils.floor_double(par6 - var29) - par3 * 16 - 1;
					int var36 = MathUtils.floor_double(par6 + var29) - par3 * 16 + 1;
					int var56 = MathUtils.floor_double(par8 - var31) - 1;
					int var38 = MathUtils.floor_double(par8 + var31) + 1;
					int var57 = MathUtils.floor_double(par10 - var29) - par4 * 16 - 1;
					int var40 = MathUtils.floor_double(par10 + var29) - par4 * 16 + 1;
						...
						for (int var43 = var57; !var58 && var43 < var40; ++var43) {
							for (int var44 = var38 + 1; !var58 && var44 >= var56 - 1; --var44) {
								...
								if (var44 >= 0 && var44 < 128) {
									if (par5ArrayOfByte[var45] == Block.blockWater.blockID
								...
								if (var59 * var59 + var46 * var46 < 1.0D) {
									for (int var50 = var38 - 1; var50 >= var56; --var50) {
										...
										if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D) {
											...
											if (var53 == Block.blockGrass.blockID) {
												var49 = true;
											}

											if (var53 == Block.blockStone.blockID || var53 == Block.blockDirt.blockID
													|| var53 == Block.blockGrass.blockID) {
												if (var50 < 10) {
													par5ArrayOfByte[var48] = 0;// (byte) Block.lavaMoving.blockID;
												} else {
													par5ArrayOfByte[var48] = 0;

													if (var49
															&& par5ArrayOfByte[var48 - 1] == Block.blockDirt.blockID) {
														/*
														 * par5ArrayOfByte[var48 - 1] = this.worldObj
														 * .getBiomeGenForCoords( var42 + par3 * 16, var45 + par4 *
														 * 16).topBlock;
														 */
													}
												}
	...
	protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte) {
		...
		for (int var8 = 0; var8 < var7; ++var8) {
			...
			for (int var16 = 0; var16 < var15; ++var16) {
				...
				this.generateCaveNode(this.rand
						.nextLong(), par4, par5, par6ArrayOfByte, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
			}
		}
	}
	...
	public void generate(IChunkProvider par1IChunkProvider, World par2World, int par3, int par4,
		...
		int var6 = this.range;
		this.rand.setSeed(par2World.seed);
		...
		for (int var11 = par3 - var6; var11 <= par3 + var6; ++var11) {
			for (int var12 = par4 - var6; var12 <= par4 + var6; ++var12) {
				...
				this.rand.setSeed(var13 ^ var15 ^ par2World.seed);
